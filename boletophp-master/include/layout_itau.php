...
<HTML>
    ...
    <BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
            ...
            <TR>
                <TD valign=top class=cp>
                    <DIV ALIGN="left">
                        ...
                        <li>Caso tenha problemas ao imprimir, copie a sequencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br>
                            <div style="text-align:center"> <input type=submit value="Imprimir" onclick="window.print();"> </div>
                        <span class="ld2">
            ...
            <TBODY>
                <TR>
                    ...
                    <TD class=ct  width=250 >
                        <div align=right>
                            Autentica��o mec�nica - <b class=cp>Ficha de Compensa��o</b>
                        </div>
                    </TD>
                </TR>
                <TR>
        ...
        <?php
            $aux = '../web/qrcode/qr_img0.50j/php/qr_img.php?';
            $aux .= 'd=TEMPLAX Tecnologia - Inovação e Futuro&';
            $aux .= 'e=H&';
            $aux .= 's=3&';
            $aux .= 't=J';
        ?>
