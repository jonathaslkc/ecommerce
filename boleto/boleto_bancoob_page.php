  ...
  * {
  ...
  <?php require_once 'boleto_bancoob.php'; ?>
  
    <div id="container">
  	<div id="instr_header">
            <h1><?php $this->dadosboleto["identificacao"]; ?> 
            <?php ($this->dadosboleto["cpf_cnpj"]) ? $this->dadosboleto["cpf_cnpj"] : '' ?></h1>
            <address><?php $this->dadosboleto["endereco"]; ?><br></address>
            <address><?php $this->dadosboleto["cidade_uf"]; ?></address>
  	</div>	<!-- id="instr_header" -->
  	...
  	<div id="boleto">
            ...
            <table class="header" border=0 cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td width=150><IMG SRC="<?php images/logobancoob.jpg ?>"></td>
                        <td width=50>
                            <div class="field_cod_banco"><?php $this->dadosboleto["codigo_banco_com_dv"]?></div>
                        </td>
                        <td class="linha_digitavel"><?php $this->dadosboleto["linha_digitavel"]?></td>
                    </tr>
                </tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="nosso_numero">Nosso n&uacute;mero</td>
                    ...
                    <tr class="campos">
  			<td class="cedente"><?php $this->dadosboleto["cedente"]; ?>&nbsp;</td>
  			<td class="ag_cod_cedente"><?php $this->boleto->dadosboleto["agencia_codigo"]?> &nbsp;</td>
  			<td class="especie"><?php $this->dadosboleto["especie"]?>&nbsp;</td>
  			<TD class="qtd"><?php $this->dadosboleto["quantidade"]?>&nbsp;</td>
  			<TD class="nosso_numero"><?php $this->dadosboleto["nosso_numero"]?>&nbsp;</td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="valor_doc">Valor documento</TD>
                    ...
                    <tr class="campos">
  			<td class="num_doc"><?php $this->dadosboleto["numero_documento"]?></td>
  			<td class="contrato"></td>
  			<td class="cpf_cei_cnpj"><?php $this->dadosboleto["cpf_cnpj"]?></td>
  			<td class="vencimento"><?php $this->dadosboleto["data_vencimento"]?></td>
  			<td class="valor_doc"><?php $this->dadosboleto["valor_boleto"]?></td>
                    </tr>
                </tbody>
            </table>
  		...
  		<tbody>
                    ...
                    <tr class="campos">
                        <td class="sacado"><?php $this->dadosboleto["sacado"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td width=150><IMG SRC="<<?php images/logobancoob.jpg ?>"></td>
  			<td width=50>
                            <div class="field_cod_banco"><?php $this->boleto->dadosboleto["codigo_banco_com_dv"]?></div>
  			</td>
  			<td class="linha_digitavel"><?php $this->boleto->dadosboleto["linha_digitavel"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="vencimento2"><?php $this->dadosboleto["data_vencimento"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="ag_cod_cedente2">Ag&ecirc;ncia/C&oacute;digo cedente</td>
                    ...
                    <tr class="campos">
  			<td class="cedente2"><?php $this->dadosboleto["cedente"]?></td>
  			<td class="ag_cod_cedente2"><?php $this->boleto->dadosboleto["agencia_codigo"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="nosso_numero2">Nosso n&uacute;mero</td>
                    ...
                    <tr class="campos">
  			<td class="data_doc"><?php $this->dadosboleto["data_documento"]?></td>
  			<td class="num_doc2"><?php $this->dadosboleto["numero_documento"]?></td>
  			<td class="especie_doc"><?php $this->dadosboleto["especie_doc"]?></td>
  			<td class="aceite"><?php $this->dadosboleto["aceite"]?></td>
  			<td class="data_process"><?php $this->dadosboleto["data_processamento"]?></td>
  			<td class="nosso_numero2"><?php $this->dadosboleto["nosso_numero"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<td class="carteira"><?php $this->dadosboleto["carteira"]?> 
                            <?php echo isset($dadosboleto["variacao_carteira"]) ? $dadosboleto["variacao_carteira"] : '&nbsp;' ?>
                        </td>
  			<td class="especie2"><?php $this->dadosboleto["especie"]?></td>
  			<td class="qtd2"><?php $this->dadosboleto["quantidade"]?></td>
  			<td class="xvalor"><?php $this->dadosboleto["valor_unitario"]?></td>
  			<td class="valor_doc2"><?php $this->dadosboleto["valor_boleto"]?></td>
                    </tr>
  		</tbody>
            </table>
  		...
  		<tbody>
  			...
  			<table class="line" cellspacing="0" cellpadding="0">
  					...
  					<p><?php $this->dadosboleto["demonstrativo1"]; ?></p>		
  					<p><?php $this->dadosboleto["demonstrativo2"]; ?></p>
  					<p><?php $this->dadosboleto["demonstrativo3"]; ?></p>
  					<p><?php $this->dadosboleto["instrucoes1"]; ?></p>
  					<p><?php $this->dadosboleto["instrucoes2"]; ?></p>
  					<p><?php $this->dadosboleto["instrucoes3"]; ?></p>
  					<p><?php $this->dadosboleto["instrucoes4"]; ?></p>
                                    </td>
                                </tr>
                            </tbody>
  			</table>
  		...
  		<tbody>
                    ...
                    <tr class="campos">
  			<td class="sacado2">
                            <p><?php $this->dadosboleto["sacado"]?></p>
                            <p><?php $this->dadosboleto["endereco1"]?></p>
                            <p><?php $this->dadosboleto["endereco2"]?></p>
  			</td>
                    </tr>
  		</tbody>
            </table>		
  		...
  		<tbody>
            ...
            <div class="barcode">
                <p><com:TImage Id="codeBar" /><!--%=$this->boleto->fbarcode($this->boleto->dadosboleto["codigo_barras"]); %--></p>
            </div>
