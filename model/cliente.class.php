...
class cliente extends crud {
    ...
    public function updateEndereco($id){
        $sql  = "UPDATE $this->table SET enedereco_id = :enedereco_id, complemento = :complemento, nro_imovel = :nro_imovel WHERE cliente_id = :id";
        $stmt = DB::prepare($sql);
        $stmt->bindParam(':enedereco_id',   $this->endereco_id);
        $stmt->bindParam(':complemento',    $this->complemento);
        $stmt->bindParam(':nro_imovel',     $this->nro_imovel);
    ...
    public function updateEnderecoDA($id){
        $sql  = "UPDATE $this->table SET nome = :nome, sobrenome = :sobrenome, fone_fixo = :fone_fixo, fone_movel = :fone_movel WHERE cliente_id = :id";
        $stmt = DB::prepare($sql);
        $stmt->bindParam(':nome',           $this->nome);
        $stmt->bindParam(':sobrenome',      $this->sobrenome);
        $stmt->bindParam(':fone_fixo',      $this->fone_fixo);
    ...
    public function updateEnderecoEmail($id){
        $sql  = "UPDATE $this->table SET email = :email WHERE cliente_id = :id";
        $stmt = DB::prepare($sql);
        $stmt->bindParam(':email',      $this->email);
        $stmt->bindParam(':id',         $id, PDO::PARAM_INT);
        return $stmt->execute();
    ...
    public function updateEnderecoSenha($id){
        $sql  = "UPDATE $this->table SET senha = :senha WHERE cliente_id = :id";
        $stmt = DB::prepare($sql);
        $stmt->bindParam(':senha',     $this->senha);
        $stmt->bindParam(':id',        $id, PDO::PARAM_INT);
        return $stmt->execute();
