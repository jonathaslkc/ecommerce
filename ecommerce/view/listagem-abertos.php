<?php
    $titulopage = 'ADM Ecommerce - Abertos';
    $nomemenu   = 'admin';
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <div class="col-sm-12">
                    <div class="blog-post-area">
                        ...
                        <div class="single-blog-post">
                            <h2>Listagem - <b class="text-success">Abertos</b></h2>
                            <br>
                            <div class="container" >
                                    ...
                                    <div class="col-sm-12 text-center">
                                        <div class="shopper-info text-left" >
                                            <form method="POST" name="" action="">
                                                <label>Organizar: <a href=''>[Primeiros]</a> - <a href=''>[Últimos]</a> - <a href=''>[À Expirar (3D)]</a></label>
                                                ...
                                                <?php
                                                    foreach($itens->findAll() as $key => $valitens): 
                                                        ...
                                                        if($itens->findAll() == NULL){
                                                            ...
                                                            echo '</td>';
                                                            echo '<td>';
                                                                echo "<a class='btn btn-warning btn-medium btn-block' target='_blank' href='editor-painelitens.php?acao=editar&id=" . $valitens->id . "'>Despachar</a>";
