                    ...
                    <div class="col-sm-6">
                        <div class="chose_area">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <ul>
                                        <li><h4><b>Nome: </b></h4></li>
                                        <li><h4><b>Celular: </b></h4></li>
                                        <li><h4><b>Telefone: </b></h4></li>
                                        <li><h4><b>Email: </b></h4></li>
                                        <li><h4><b>Endereço: </b></h4></li>
                                        <li><h4><b>Bairro/CEP: </b></h4></li>
                                        <li><h4><b>Cidade: </b></h4></li>
                                        <li><h4><b>Estado: </b></h4></li>
                                    </ul>
                                </div>
                                <div class="col-sm-9 text-left">
                                    <ul>
                                        <li><h4><?php echo $_SESSION['usuario'].' '.$resulDadosCliente->sobrenome; ?> </h4></li>
                                        <li><h4><?php echo $resulDadosCliente->fone_movel; ?> </h4></li>
                                        <li><h4><?php echo $resulDadosCliente->fone_fixo; ?> </h4></li>
                                        <li><h4><?php echo $_SESSION['emailusu']; ?> </h4></li>
                                        <li><h4><?php echo utf8_encode($resulDadosEntrega->logradouro).', '.$resulDadosCliente->nro_imovel.' - '.$resulDadosCliente->complemento; ?> </h4></li>
                                        <li><h4><?php echo $resulDadosEntrega->bairro.' / '.$resulDadosEntrega->cep; ?> </h4></li>
                                        <li><h4><?php echo $resulDadosCidade->nome; ?> </h4></li>
                                        <li><h4><?php echo $resulDadosEstado->nome; ?> </h4></li>
                                    </ul>
                                </div>
                                <div class="col-sm-12">
                                    <br>
