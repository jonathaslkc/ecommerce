<?php
    $titulopage = 'ADM Ecommerce - Usuários';
    $nomemenu   = 'admin';
?>
<!DOCTYPE html>
<html lang="pt-br">
                    ...
                    <div class="blog-post-area">
                        ...
                        <div class="breadcrumbs">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="painelfuncionarios.php">Cadastro de Funcionário</a></li>
                                <li class="active">Listagem -Acesso</li>
                            </ol>
			</div><!--/breadcrums-->
                        
                        <div class="single-blog-post">
                            <h3>Listagem de Funcionários e Clientes</h3>
                            <br>
                            <div class="container" >
                                    ...
                                    <div class="col-sm-12 text-center">
                                        <div class="shopper-info text-left" >
                                            <form method="POST" name="" action="">
                                                <label>Organizar: <a href=''>[Ordem Alfabética]</a> - <a href=''>[Ativos]</a></label>
                                                <input type="text" placeholder="Pesquisar por Username">
                                            </form>
                                        </div>
                                                ...
                                                <?php
                                                    foreach($itens->findAll() as $key => $valitens): 
                                                        ...
                                                        if($itens->findAll() == NULL){
                                                            ...
                                                            echo '</td>';
                                                            echo '<td>';
                                                            echo "<a class='btn btn-warning btn-medium btn-block' target='_blank' href='editor-painelitens.php?acao=editar&id=" . $valitens->id . "'>Senha</a>";
                                                                echo "<a class='btn btn-info btn-medium btn-block' target='_blank' href='editor-painelitens.php?acao=editar&id=" . $valitens->id . "'>Editar</a>";
                                                                echo "<a class='btn btn-danger btn-medium btn-block' href='listagem-itens.php?acaoItemdel=deletar&id=" . $valitens->id . "' onclick='return confirm(\"Deseja realmente deletar " . $valitens->nome . " ?\")'>Deletar</a>";
                                                            echo '</td>';
                                                        }
                                                        echo '</tr>';
                                                    endforeach;
