...
<?php
        ...
        if(isset($_GET['acao']) && $_GET['acao'] == 'additemcar'):
            ...
            if(empty($_SESSION['item'][$iditem])):
                ...
                $resultado = $itens->find($iditem);
                $resultadoP= $preco->find2($iditem);
            
                $_SESSION['item'][$iditem] = array($iditem,$resultado->nome,1,$resultadoP->preco_venda,$resultado->peso,$resultado->altura,$resultado->largura,$resultado->profundidade);
